...
structure.read_pdb('Ap4Aase_new_3.pdb', dir='..')
...
Relax_fit(pipe_name='rx', pipe_bundle=pipe_bundle, file_root='rx', results_dir='.', grid_inc=21, mc_sim_num=500, view_plots=True)
