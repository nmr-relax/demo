...
# Load the PDB file.
structure.read_pdb('1F35_H.pdb', read_mol=1, set_mol_name='OMP')
...
relax_data.read(ri_id='R1_600',  ri_type='R1',  frq=600*1e6, file='rates.txt', res_name_col=1, res_num_col=2, data_col=3,  error_col=4,  spin_id="@N")
relax_data.read(ri_id='R2_600',  ri_type='R2',  frq=600*1e6, file='rates.txt', res_name_col=1, res_num_col=2, data_col=5,  error_col=6,  spin_id="@N")
relax_data.read(ri_id='NOE_600', ri_type='NOE', frq=600*1e6, file='rates.txt', res_name_col=1, res_num_col=2, data_col=7,  error_col=8,  spin_id="@N")
relax_data.read(ri_id='R1_800',  ri_type='R1',  frq=800*1e6, file='rates.txt', res_name_col=1, res_num_col=2, data_col=9,  error_col=10, spin_id="@N")
relax_data.read(ri_id='R2_800',  ri_type='R2',  frq=800*1e6, file='rates.txt', res_name_col=1, res_num_col=2, data_col=11, error_col=12, spin_id="@N")
relax_data.read(ri_id='NOE_800', ri_type='NOE', frq=800*1e6, file='rates.txt', res_name_col=1, res_num_col=2, data_col=13, error_col=14, spin_id="@N")
...
value.set(-160 * 1e-6, 'csa', spin_id='@N*')
